      ...
      <div className="dasboard">
        ...
        <div className="dasboard-container">
          <div className="dasboard-siderbar">
            ...
            />
            <SidebarBtn
              handle={() => setCvalue("Create Task")}
              value="Create Task"
              clickValue={cvalue}
              link="/dasboard/task/create"
              Icon={faPlus}
            />
            <SidebarBtn
              handle={() => setCvalue("All Task")}
              value="All Task"
              clickValue={cvalue}
              link="/dasboard/task/all"
              Icon={faListAlt}
            />
            <SidebarBtn
              handle={() => setCvalue("Completed Task")}
              value="Completed Task"
              clickValue={cvalue}
              link="/dasboard/task/completed"
              Icon={faCheck}
            />
            <SidebarBtn
              handle={() => setCvalue("Important Task")}
              value="Important Task"
              clickValue={cvalue}
              link="/dasboard/task/important"
              iconx={starx}
            />
            <SidebarBtn
              handle={() => setCvalue("Analytics")}
              value="Analytics"
              clickValue={cvalue}
              link="/dasboard/analytics"
              iconx={analytics}
            />
